...
最終更新: 2026-06-06. このファイルは作業継続用のメモ。再開時はまずこれを読む。
※ §5 のブラウザ非表示問題は **解決済 (2026-06-06)**。IPAT の実弾検証も完了し
`AUTO_PURCHASE_VERIFIED=True` (2026-05-31 実機検証)。本文の古い記述は履歴として残す。
...
## 5. ★解決済 (2026-06-06)★ make api 経由でブラウザ非表示だった問題 (以下は当時の記録)
