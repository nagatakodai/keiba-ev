...
FEATURE_GRID: dict[str, dict[str, list[float]]] = {
    ...
    # Claude 指数 1/2/3位の生値 (ユーザ指示 2026-07-06「指数60と指数70で指数1位なのは差が
    # あるはず」)。丸い閾値は実分布の四分位近傍 (111R: idx1 p25=72/med=78/p75=83,
    # idx2 63/68/72, idx3 54/61/66)。
    "idx1":          {"min": [80, 85], "max": [70, 75]},
    "idx2":          {"min": [70, 75], "max": [60, 65]},
    "idx3":          {"min": [65, 70], "max": [55, 60]},
}
